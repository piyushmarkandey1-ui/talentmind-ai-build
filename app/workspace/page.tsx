    ...
    for (const resume of resumes) {
      if (!resume.file) {
        newResults.push({
          ...
          status: 'error',
          error: 'File reference lost — please re-upload this resume.',
        })
      ...
      try {
        ...
        newResults.push({
          ...
          fileName: resume.name,
          status: 'error',
          error: error.message || 'Failed to analyze this resume.',
        })
      }
          ...
          >
            <div className="flex flex-col items-center gap-6 rounded-3xl border border-border/60 bg-white/[0.03] p-10 shadow-2xl">
              ...
              <p className="text-xs text-muted-foreground/60">
                This may take 15–30 seconds per resume
              </p>
            </div>
          </motion.div>
        )}
          ...
          {analysisError && (
            ...
            >
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-rose-300/80">{analysisError}</span>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
