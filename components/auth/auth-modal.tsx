          ...
          >
            ...
            >
              ...
              <button
                ...
                disabled={loading}
                className={cn(
                  'mb-4 flex w-full items-center justify-center gap-3 rounded-xl border px-4 py-3 text-sm font-medium transition-colors',
                  isLight
              ...
              <div className="relative my-6">
                <div className={cn('absolute inset-0 flex items-center', isLight ? 'border-gray-200' : 'border-border')}>
                  <div className="w-full border-t" />
                </div>
                <div className="relative flex justify-center text-xs uppercase">
                  <span className={cn('bg-white px-2', isLight ? 'text-gray-400' : 'text-muted-foreground')}>
